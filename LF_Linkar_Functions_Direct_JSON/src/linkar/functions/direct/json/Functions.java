package linkar.functions.direct.json;
...
public class Functions
{
	...
	/**
	 * Reads one or several records of a file in a synchronous way with JSON input and output format.
	 * <p>
	 * Example:
	 * <pre>
	 * import linkar.*;
    ...
    {
        return DirectFunctions.Read(credentialOptions, filename, records, dictionaries, readOptions, DATAFORMAT_TYPE.JSON, jsonFormat.getCRUFormat(), customVars, receiveTimeout);
    }
    ...
    {
        return Read(credentialOptions, filename, records, dictionaries, readOptions, jsonFormat, customVars,0);
    }
    ...
    {
        return Read(credentialOptions, filename, records, dictionaries, readOptions, jsonFormat, "");
    }
    ...
    {
        return Read(credentialOptions, filename, records, dictionaries, readOptions, JSON_FORMAT.JSON);
    }
    ...
    public static String Update(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout) throws Exception
    {
        return DirectFunctions.Update(credentialOptions, filename, records, updateOptions,  DATAFORMAT_TYPE.JSON, jsonFormat.getCRUFormat(), customVars, receiveTimeout);
    }
    ...
    public static String Update(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat, String customVars) throws Exception
    {
        return Update(credentialOptions, filename, records, updateOptions, jsonFormat, customVars, 0);
    }
    ...
    public static String Update(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat) throws Exception
    {
        return Update(credentialOptions, filename, records, updateOptions, jsonFormat, "");
    }
    ...
    {
        return Update(credentialOptions, filename, records, updateOptions, JSON_FORMAT.JSON);
    }
    ...
    /**
     * Update one or more attributes of one or more file records, in a synchronous way with JSON input and output format.
     * <p>
     * Inside the records argument, the recordIds and the modified records always must be specified. But the originalRecords not always.
     * When {@link UpdateOptions} argument is specified and the {@link UpdateOptions#getOptimisticLockControl} property is set to true, a copy of the record must be provided before the modification (originalRecords argument)
     * to use the Optimistic Lock technique. This copy can be obtained from a previous {@link #Read} operation. The database, before executing the modification, 
    ...
    public static String UpdatePartial(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout) throws Exception
    {
        return DirectFunctions.UpdatePartial(credentialOptions, filename, records, "", updateOptions,  DATAFORMAT_TYPE.JSON, jsonFormat.getCRUFormat(), customVars, receiveTimeout);
    }
    ...
    public static String UpdatePartial(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat, String customVars) throws Exception
    {
        return UpdatePartial(credentialOptions, filename, records, updateOptions, jsonFormat, customVars, 0);
    }
    ...
    public static String UpdatePartial(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat) throws Exception
    {
        return UpdatePartial(credentialOptions, filename, records, updateOptions, jsonFormat, "");
    }
    ...
    {
        return UpdatePartial(credentialOptions, filename, records, updateOptions, JSON_FORMAT.JSON);
    }
    ...
    public static String New(CredentialOptions credentialOptions, String filename, String records, NewOptions newOptions,
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout) throws Exception
    {
        return DirectFunctions.New(credentialOptions, filename, records, newOptions, DATAFORMAT_TYPE.JSON, jsonFormat.getCRUFormat(), customVars, receiveTimeout);
    }
    ...
    public static String New(CredentialOptions credentialOptions, String filename, String records, NewOptions newOptions,
        JSON_FORMAT jsonFormat, String customVars) throws Exception
    {
        return New(credentialOptions, filename, records, newOptions, jsonFormat, customVars, 0);
    }
    ...
    public static String New(CredentialOptions credentialOptions, String filename, String records, NewOptions newOptions,
        JSON_FORMAT jsonFormat) throws Exception
    {
        return New(credentialOptions, filename, records, newOptions, jsonFormat, "");
    }
    ...
    {
        return New(credentialOptions, filename, records, newOptions, JSON_FORMAT.JSON);
    }
    ...
    /**
     * Deletes one or several records in file, in a synchronous way with JSON input and output format.
     * <p>
	 ...
	 *			result = Functions.Select(credentials, "LK.CUSTOMERS", "","","","", options, JSON_FORMAT.JSON, "", 60);			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
    ...
    public static String Select(CredentialOptions credentialOptions, String filename, String selectClause, String sortClause, String dictClause, String preSelectClause, SelectOptions selectOptions,
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout) throws Exception
    {
        return DirectFunctions.Select(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat.getCRUFormat(), customVars, receiveTimeout);
    }
	 ...
	 *			CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
	 *			SelectOptions options = new SelectOptions();
	 *			result = Functions.Select(credentials, "LK.CUSTOMERS", "","","","", options, JSON_FORMAT.JSON, "");			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
    ...
    public static String Select(CredentialOptions credentialOptions, String filename, String selectClause, String sortClause, String dictClause, String preSelectClause, SelectOptions selectOptions,
        JSON_FORMAT jsonFormat, String customVars) throws Exception
    {
        return Select(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat, customVars, 0);
    }
    ...
    public static String Select(CredentialOptions credentialOptions, String filename, String selectClause, String sortClause, String dictClause, String preSelectClause, SelectOptions selectOptions,
        JSON_FORMAT jsonFormat) throws Exception
    {
        return Select(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat, "");
    }
    ...
    {
        return Select(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, JSON_FORMAT.JSON);
    }
    ...
    /**
     * Executes a subroutine, in a synchronous way with JSON input and output format.
     * <p>
	 * Example:
     * <pre>
	 * import linkar.*;
	 ...
	 *			result = Functions.LkProperties(credentials, "LK.CUSTOMERS", options, JSON_FORMAT.JSON, "", 60);			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
	 ...
	 *			CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
	 *			LkPropertiesOptions options = new LkPropertiesOptions();
	 *			result = Functions.LkProperties(credentials, "LK.CUSTOMERS", options, JSON_FORMAT.JSON, "");			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
    ...
    public static String LkProperties(CredentialOptions credentialOptions, String filename, LkPropertiesOptions lkPropertiesOptions,
        JSON_FORMAT jsonFormat, String customVars) throws Exception
    {
        return LkProperties(credentialOptions, filename, lkPropertiesOptions, jsonFormat, customVars, 0);
    }
    ...
    public static String LkProperties(CredentialOptions credentialOptions, String filename, LkPropertiesOptions lkPropertiesOptions,
		JSON_FORMAT jsonFormat) throws Exception
    {
        return LkProperties(credentialOptions, filename, lkPropertiesOptions, jsonFormat, "");
    }
    ...
    {
        return LkProperties(credentialOptions, filename, lkPropertiesOptions, JSON_FORMAT.JSON, "");
    }
...
/* READ */
     ...
     *              "  ]" +
     *              "}",
	 * 				"",options, JSON_FORMAT.JSON, "", 60).getNow(result);		
	 * 		}
	 * 		catch (Exception ex)
	 * 		{
	 * 			String error = ex.getMessage();
    ...
    { 	   	
    	return CompletableFuture.supplyAsync(() -> {
				try {
					return Functions.Read(credentialOptions, filename, records, dictionaries, readOptions, jsonFormat, customVars, receiveTimeout);
				} catch (Exception e) {
     ...
     *              "  ]" +
     *              "}",
	 * 				"",options, JSON_FORMAT.JSON, "").getNow(result);		
	 * 		}
	 * 		catch (Exception ex)
	 * 		{
	 * 			String error = ex.getMessage();
    ...
    public static CompletableFuture<String> ReadAsync(CredentialOptions credentialOptions, String filename, String records, String dictionaries, ReadOptions readOptions,
        JSON_FORMAT jsonFormat, String customVars) throws Exception
    { 	   	
    	return ReadAsync(credentialOptions, filename, records, dictionaries, readOptions, jsonFormat, customVars, 0);
    }
    ...
    public static CompletableFuture<String> ReadAsync(CredentialOptions credentialOptions, String filename, String records, String dictionaries, ReadOptions readOptions,
        JSON_FORMAT jsonFormat) throws Exception
    { 	   	
    	return ReadAsync(credentialOptions, filename, records, dictionaries, readOptions, jsonFormat, "");
    }
    ...
    { 	   	
    	return ReadAsync(credentialOptions, filename, records, dictionaries, readOptions, JSON_FORMAT.JSON);
    }
    ...
    public static CompletableFuture<String> UpdateAsync(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout)
    {
    	return CompletableFuture.supplyAsync(() -> {
				try {
					return Functions.Update(credentialOptions, filename, records, updateOptions, jsonFormat, customVars, receiveTimeout);
				} catch (Exception e) {
					throw new CompletionException(e);
				}
		});
     ...
     */
    public static CompletableFuture<String> UpdateAsync(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat, String customVars)
    {
    	return UpdateAsync(credentialOptions, filename, records, updateOptions, jsonFormat, customVars, 0);
    }
    ...
    {
    	return UpdateAsync(credentialOptions, filename, records, updateOptions, jsonFormat, "");
    }
    ...
    public static CompletableFuture<String> UpdateAsync(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions)
    {
    	return UpdateAsync(credentialOptions, filename, records, updateOptions, JSON_FORMAT.JSON);
    }
        ...
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout)
    {
    	return CompletableFuture.supplyAsync(() -> {
				try {
					return Functions.UpdatePartial(credentialOptions, filename, records, updateOptions, jsonFormat, customVars, receiveTimeout);
				} catch (Exception e) {
					throw new CompletionException(e);
				}
		});
    ...
    public static CompletableFuture<String> UpdatePartialAsync(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat, String customVars)
    {
    	return UpdatePartialAsync(credentialOptions, filename, records, updateOptions, jsonFormat, customVars, 0);
    }
    ...
    public static CompletableFuture<String> UpdatePartialAsync(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions,
        JSON_FORMAT jsonFormat)
    {
    	return UpdatePartialAsync(credentialOptions, filename, records, updateOptions, jsonFormat, "");
    }
    ...
    public static CompletableFuture<String> UpdatePartialAsync(CredentialOptions credentialOptions, String filename, String records, UpdateOptions updateOptions)
    {
    	return UpdatePartialAsync(credentialOptions, filename, records, updateOptions, JSON_FORMAT.JSON);
    }
        ...
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout)
    {
    	return CompletableFuture.supplyAsync(() -> {
				try {
					return Functions.New(credentialOptions, filename, records, newOptions, jsonFormat, customVars, receiveTimeout);
				} catch (Exception e) {
					throw new CompletionException(e);
				}
		});
    ...
    public static CompletableFuture<String> NewAsync(CredentialOptions credentialOptions, String filename, String records, NewOptions newOptions,
        JSON_FORMAT jsonFormat, String customVars)
    {
    	return NewAsync(credentialOptions, filename, records, newOptions, jsonFormat, customVars, 0);
    }
    ...
    public static CompletableFuture<String> NewAsync(CredentialOptions credentialOptions, String filename, String records, NewOptions newOptions,
        JSON_FORMAT jsonFormat)
    {
    	return NewAsync(credentialOptions, filename, records, newOptions, jsonFormat, "");
    }
    ...
    public static CompletableFuture<String> NewAsync(CredentialOptions credentialOptions, String filename, String records, NewOptions newOptions)
    {
    	return NewAsync(credentialOptions, filename, records, newOptions, JSON_FORMAT.JSON);
    }
	 ...
	 *			CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
	 *			SelectOptions options = new SelectOptions();
	 *			result = Functions.SelectAsync(credentials, "LK.CUSTOMERS", "","","","", options, JSON_FORMAT.JSON, "", 60).getNow(result);			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
        ...
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout)
    {
    	return CompletableFuture.supplyAsync(() -> {
				try {
					return Functions.Select(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat, customVars, receiveTimeout);
				} catch (Exception e) {
					throw new CompletionException(e);
				}
		});
	 ...
	 *			CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
	 *			SelectOptions options = new SelectOptions();
	 *			result = Functions.SelectAsync(credentials, "LK.CUSTOMERS", "","","","", options, JSON_FORMAT.JSON, "").getNow(result);			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
    ...
    public static CompletableFuture<String> SelectAsync(CredentialOptions credentialOptions, String filename, String selectClause, String sortClause, String dictClause, String preSelectClause, SelectOptions selectOptions,
        JSON_FORMAT jsonFormat, String customVars)
    {
    	return SelectAsync(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat, customVars, 0);
    }
    ...
    public static CompletableFuture<String> SelectAsync(CredentialOptions credentialOptions, String filename, String selectClause, String sortClause, String dictClause, String preSelectClause, SelectOptions selectOptions,
        JSON_FORMAT jsonFormat)
    {
    	return SelectAsync(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, jsonFormat, "");
    }
    ...
    public static CompletableFuture<String> SelectAsync(CredentialOptions credentialOptions, String filename, String selectClause, String sortClause, String dictClause, String preSelectClause, SelectOptions selectOptions)
    {
    	return SelectAsync(credentialOptions, filename, selectClause, sortClause, dictClause, preSelectClause, selectOptions, JSON_FORMAT.JSON);
    }
	 ...
	 *			CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
	 *			LkPropertiesOptions options = new LkPropertiesOptions();
	 *			result = Functions.LkPropertiesAsync(credentials, "LK.CUSTOMERS", options, JSON_FORMAT.JSON, "", 60).getNow(result);			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
        ...
        JSON_FORMAT jsonFormat, String customVars, int receiveTimeout)
    {
    	return CompletableFuture.supplyAsync(() -> {
				try {
					return Functions.LkProperties(credentialOptions, filename, lkPropertiesOptions, jsonFormat, customVars, receiveTimeout);
				} catch (Exception e) {
					throw new CompletionException(e);
				}
		});
	 ...
	 *			CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
	 *			LkPropertiesOptions options = new LkPropertiesOptions();
	 *			result = Functions.LkPropertiesAsync(credentials, "LK.CUSTOMERS", options, JSON_FORMAT.JSON, "").getNow(result);			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
    ...
    public static CompletableFuture<String> LkPropertiesAsync(CredentialOptions credentialOptions, String filename, LkPropertiesOptions lkPropertiesOptions,
		JSON_FORMAT jsonFormat, String customVars)
    {
    	return LkPropertiesAsync(credentialOptions, filename, lkPropertiesOptions, jsonFormat, customVars, 0);
    }
	 ...
	 *			CredentialOptions credentials = new CredentialOptions("127.0.0.1", "EPNAME", 11300, "admin", "admin");
	 *			LkPropertiesOptions options = new LkPropertiesOptions();
	 *			result = Functions.LkPropertiesAsync(credentials, "LK.CUSTOMERS", options, jsonFormat).getNow(result);			
	 *		}
	 *		catch (Exception ex)
	 *		{
	 *			String error = ex.getMessage();
    ...
    public static CompletableFuture<String> LkPropertiesAsync(CredentialOptions credentialOptions, String filename, LkPropertiesOptions lkPropertiesOptions,
		JSON_FORMAT jsonFormat)
    {
    	return LkPropertiesAsync(credentialOptions, filename, lkPropertiesOptions, jsonFormat);
    }
    ...
    public static CompletableFuture<String> LkPropertiesAsync(CredentialOptions credentialOptions, String filename, LkPropertiesOptions lkPropertiesOptions)
    {
    	return LkPropertiesAsync(credentialOptions, filename, lkPropertiesOptions, JSON_FORMAT.JSON);
    }
